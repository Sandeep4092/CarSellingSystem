...
public class AdminSection extends JFrame implements ActionListener
{
    ...
    AdminSection()
    {
       ...
       ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("Library/icon/cars.jpeg"));
       Image i=img.getImage().getScaledInstance(1400,800,Image.SCALE_AREA_AVERAGING);
       ImageIcon img2=new ImageIcon(i);
       l1=new JLabel(img2);
       
       JMenuBar m1=new JMenuBar();
       JMenu me1=new JMenu("Add");
       JMenuItem men1=new JMenuItem("Add SalesMen");
       
       JMenu me2=new JMenu("View");
       JMenuItem men2=new JMenuItem("View SalesMen");
       
       JMenu me3=new JMenu("Delete");
       JMenuItem men3=new JMenuItem("Remove SalesMen");
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        if(cmd.equals("Add SalesMen"))
        {
            new AddAdmins().setVisible(true);
        }
        else if(cmd.equals("View SalesMen"))
         {
            new ViewAdmins().setVisible(true); 
         }
        else if(cmd.equals("Remove SalesMen"))
        {
